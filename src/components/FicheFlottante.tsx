 ...
 * commune) ; sur téléphone, il occupe tout l'écran. Fermer revient à l'état
 * précédent de l'historique — c'est la navigation qui porte l'ouverture
 * (voir (carte)/@detail), donc le bouton retour du navigateur ferme aussi.
 *
