...
import { LienCarte } from "@/components/LienCarte";
...
export default async function FicheVille({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="pb-4">
      <LienCarte className="inline-flex items-center gap-1.5 py-2 text-[13px] text-texte-doux transition-colors hover:text-accent">
